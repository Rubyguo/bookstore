...
class BooklistsControllerTest < ActionController::TestCase
  ...
  test "should create booklist" do
    assert_difference('Booklist.count') do
      post :create, booklist: { bl_type: @booklist.bl_type, intro: @booklist.intro, title: @booklist.title, user_id: @booklist.user_id }
    end
  ...
  test "should update booklist" do
    patch :update, id: @booklist, booklist: { bl_type: @booklist.bl_type, intro: @booklist.intro, title: @booklist.title, user_id: @booklist.user_id }
    assert_redirected_to booklist_path(assigns(:booklist))
  end
